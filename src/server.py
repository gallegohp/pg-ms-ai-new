...
- pg-ms-operation: equipos, asistencias y proveedores.
...
def create_server() -> FastMCP:
    ...
    # =====================================================================
    # REPORTES (pg-ms-reports): ingresos, mora, afluencia
    # =====================================================================
    ...
    # (afluencia) en la cuenta de servicio del MCP; si esa cuenta no tiene
    # el rol adecuado, el backend responde 403.
    ...
    async def reporte_ingresos_ultimos_seis_meses(dummy: str = "") -> dict:
        return await _request("GET", "/pg-ms-reports/api/reportes/ingresos/ultimos-seis-meses")
    ...
    async def reporte_mora(fechaInicio: Optional[str] = None, fechaFin: Optional[str] = None) -> dict:
        ...
        return await _request("GET", "/pg-ms-reports/api/reportes/mora", params=params)
    ...
    async def reporte_afluencia_hoy(dummy: str = "") -> dict:
        return await _request("GET", "/pg-ms-reports/api/reportes/afluencia/hoy")
